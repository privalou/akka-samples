...
public class DeviceTest extends JUnitSuite {
    ...
    public void testReplyToRegistrationRequests() {
        ...
        ActorRef deviceActor = system.actorOf(Device.props("device"));

        deviceActor.tell(new DeviceGroup.RequestTrackDevice("device"), probe.getRef());
        probe.expectMsgClass(DeviceGroup.DeviceRegistered.class);
    ...
    public void testIgnoreWrongRegistrationRequests() {
        ...
        deviceActor.tell(new DeviceGroup.RequestTrackDevice("wrongDevice"), probe.getRef());
